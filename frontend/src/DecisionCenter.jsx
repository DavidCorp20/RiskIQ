...
export default function DecisionCenter({decisionEngine,result,priorities=[],datasetId}){
 ...
 const selectedEvidence=selected?.evidence&&!Array.isArray(selected.evidence)?selected.evidence:evidence
