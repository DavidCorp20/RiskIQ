...
class DecisionPipelineService:
    ...
    def build(
        ...
        # Temporal deterioration is evidence in its own right and should create
        # a reviewable recommendation even when the current level is below a
        # static risk threshold.
        if history["alerts"]:
